...
int SetBitValue2Register(int bit, int value, volatile unsigned long *reg,int format)
{
	if (value == 0)
		*reg  &= complement ((1 << bit),format); // Set reg[bit] to 0
	else
  		*reg  |= (1 << bit) ; // Set reg[bit] to 1
return 0 ;
}
...
printf("pconp %ld \n",PCONP);
//SetBitValue2Register(7,0,&PCONP,32);
...
SetBitValue2Register(14,0,&PCLKSEL0,32);
SetBitValue2Register(15,0,&PCLKSEL0,32);
...
printf(" I2C0SCLL : %ld \n",I2C0SCLL);
  ...
  // Affectation directe du bit P0_28 bit 24:24=01 registre PINSEL1
  // soit bit 24 et 22 = 1
...
//  PINSEL1 |= 0x1400000;
	...
	// Enable I2C
SetBitValue2Register(22,1,&PINSEL1,32);
SetBitValue2Register(23,0,&PINSEL1,32);
SetBitValue2Register(24,1,&PINSEL1,32);
SetBitValue2Register(25,0,&PINSEL1,32);
  I2C_EnableI2C();
  __I2C_ClearFlag(I2CON_STAC | I2CON_SIC | I2CON_AAC);
printf("\nFin de la fonction InitMaster\n");
